...
2026-01-17 02:09:20 - Протестированы внешние ретриверы FastGPT/RAGFlow; добавлены тесты и убраны заглушки NotImplementedError.
2026-01-17 03:03:35 - Протестирована загрузка config.yaml и исправлен парсинг MCP-конфигурации; добавлены тесты.
