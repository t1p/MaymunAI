...
SEARCH_SETTINGS = {
    ...
    'similarity_threshold': 0.45,  # Порог сходства (документы с меньшим сходством игнорируются)
}
...
KEYWORDS_SETTINGS = {
    'prompt': "Подбери три ключевых слова, по которым лучше всего можно найти ответ в тексте, на этот запрос. В ответе перечисли их через запятую. Текст запроса: {query}",
    'model': 'gpt-3.5-turbo',
    'temperature': 0.3,
    'max_tokens': 100
}
