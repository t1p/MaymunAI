...
KEYWORDS_SETTINGS = {
    'prompt': "Подбери три ключевых фразы или слова, по которым лучше всего можно найти ответ в тексте, на этот запрос. В ответе перечисли их через запятую. Текст запроса: {query}",
    'model': 'gpt-3.5-turbo',
    'temperature': 0.3,
    'max_tokens': 100
}
